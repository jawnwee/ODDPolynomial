...
// ODDPolynomial
#define COCOAPODS_POD_AVAILABLE_ODDPolynomial
#define COCOAPODS_VERSION_MAJOR_ODDPolynomial 0
#define COCOAPODS_VERSION_MINOR_ODDPolynomial 1
#define COCOAPODS_VERSION_PATCH_ODDPolynomial 0
